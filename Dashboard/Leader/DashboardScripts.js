...
document.getElementById("AddEventsButton").addEventListener("click", function() {
    window.location.href = '/Events-Modification/Add-events/';
});

document.getElementById("CODEventsButton").addEventListener("click", function() {
    window.location.href = '/Events-Modification/Change-or-Delete-Events/';
});

document.getElementById("MORPointsButton").addEventListener("click", function() {
    window.location.href = '/Member-Modifications/Modify-Member-Points/';
});

document.getElementById("CODUsersButton").addEventListener("click", function() {
    window.location.href = '/Member-Modifications/Change-or-Delete-Members/';
});
